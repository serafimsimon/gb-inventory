package ru.gb.inventory.department.configs;
    ...
    public WebClient userServiceWebClient(){
        TcpClient tcpClient = TcpClient
                ...
                .doOnConnected(connection -> {
                    ...
                    connection.addHandlerFirst(new WriteTimeoutHandler(userServiceIntegrationProperties.getWriteTimeout(), TimeUnit.MILLISECONDS));
                });
